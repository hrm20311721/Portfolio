        ...
        <footer class="footer container border-top pt-3">
            <div class="row justify-content-between align-items-center">
                <div class="footer-logo d-flex flex-column justify-content-center align-items-center col-4">
                    ...
                    <small class="d-inline-block">Copyright(C) hrm20311721</small>
                </div>
                <div class="footer-menu col-5">
                    <ul class="footer-list list-unstyled d-flex justify-content-evenly">
                        <li class="footer-item">
                            <a href="" class="btn btn-outline-dark border-0 bg-transparent">
                        ...
                        <li class="footer-item">
                            <a href="" class="btn btn-outline-dark border-0 bg-transparent">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-envelope"
                                    viewBox="0 0 16 16">
                                    <path
